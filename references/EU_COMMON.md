...
## Regulatory horizon (2026)

### EDPB Coordinated Enforcement — Transparency (LIVE, 2026)
On **19 March 2026** the EDPB launched its 2026 Coordinated Enforcement Framework (CEF) action on **transparency and the right to information (Arts. 12–14)**. This is a live, EU-wide enforcement priority for 2026 — supervisory authorities are actively reviewing transparency compliance across the bloc. Treat completeness of the Art. 13/14 disclosures (and the clarity/accessibility duties in Art. 12) as elevated-risk this year: notices generated by this skill should pass the full Art. 13/14 checklist above with no gaps.

### Digital Omnibus — reduced transparency (PROPOSED, not in force)
The Commission's Digital Omnibus Regulation (**COM(2025) 837 final**, 19 November 2025, procedure **2025/0360(COD)**; the GDPR amendments are **Article 3** of that proposal) proposes to **reduce** the Art. 13/14 transparency burden in limited cases (e.g. data obtained from the data subject who is likely already informed, low-intensity processing, no automated decision-making or high-risk processing or transfer). This is a proposal in the ordinary legislative procedure as of 2026-05-31 — **not law**. Apply the full Art. 13/14 obligations; flag the proposal only as forward planning.

*Instrument note (corrected 2026-07-21):* the Digital Omnibus package of 19 November 2025 is COM(2025) 836 (Digital Omnibus on AI, 2025/0359(COD)), COM(2025) 837 (Digital Omnibus Regulation — data, privacy and cybersecurity, carrying the GDPR amendments in Art. 3) and COM(2025) 838 (European Business Wallets). There is no COM(2025) 833 in the package; earlier versions of this file cited that number in error. Primary source: https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=celex:52025PC0837
